#!/usr/bin/env python
''' Send Redis usage metrics to Amazon CloudWatch This is intended to run on an Amazon EC2 instance and requires a boto config (~/.boto) allowing to write CloudWatch metrics. '''
import redis
...
def collect_redis_info():
    r = redis.StrictRedis('localhost', port=6379, db=0, password='BS/5WDyDniL/iYDS9I+Ruvf8Fw5pYbmjfcmwRQqCw1NIK6WsHpMXx1/nPg5YQQmqvef0IAa2t3IZUrhi')
    info = r.info()
